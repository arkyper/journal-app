...
//         String gmail = "william.henry.harrison@example-pet-store.com";
//         boolean isSentimentAnalysis = true;

//         User user = new User(id, userName, password,  gmail, isSentimentAnalysis, journalEntries, roles);
...
//         User user = new User(null, userName, password,  gmail, isSentimentAnalysis, new ArrayList<>(), null); // Using constructor with null for optional fields
